...
config.llvm_shlib_dir = "/Users/dianavalenzuela/llvm-tutor/build-injectfunc/lib"
...
config.test_exec_root = os.path.join("/Users/dianavalenzuela/llvm-tutor/build-injectfunc/test")
